...
class ForexLoader:
    ...
    def get_data_from_csv(self, symbol):
        ...
        # --- SỬA LỖI Ở ĐÂY: Đọc CSV và ép kiểu datetime một cách tường minh ---
        dataframe = pd.read_csv(
            filepath,
            header=0,
            index_col=0 # Vẫn đọc cột đầu tiên làm index
        )
        # Chuyển đổi index (hiện đang là chuỗi) thành đối tượng datetime
